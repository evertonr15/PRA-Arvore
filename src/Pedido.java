...
public class Pedido {
	...
	public String toString() {
		...
		informacoesDoPedido = "" + getCodigoPedido();
		informacoesDoPedido += ";" + getCliente().getCodigoCliente();
		informacoesDoPedido += ";" + getVendedor().getCodigoVendedor();
		informacoesDoPedido += ";" + getDataPedido();
		informacoesDoPedido += ";" + getTotalDaVenda();
		informacoesDoPedido += ";" + getProdutos().toString();
